"""
Stworz klase reprezentujaca produkt: id, nazwe, cene
...
class ShopService:
    ...
    def interview_with_client(self):
        basket = Basket()

        while True:
            choice = input("\nCo chcesz kupic (podaj id produktu lub q by zakonczyc)? ")
            if choice.lower() == "q":
                break
            ...
            try:
                ...
                print("Nie ma takiego produktu w ofercie.")
                continue
